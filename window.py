...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        # 初始化界面
        super().__init__()
        self.setWindowTitle('基于yolov5的智能口罩识别系统')
        self.resize(1200, 800)
        self.setWindowIcon(QIcon("images/UI/lzy.png"))
    ...
    ***界面初始化***
    ...
    def initUI(self):
        # 图片检测子界面
        font_title = QFont('华文行楷', 25)
        font_main = QFont('华文行楷', 18)
        ...
        self.left_img.setPixmap(QPixmap("images/UI/lzy01.jpeg"))
        self.right_img.setPixmap(QPixmap("images/UI/lzy02.jpeg"))
        ...
        up_img_button.setStyleSheet("QPushButton{color:blue}"
        ...
        det_img_button.setStyleSheet("QPushButton{color:blue}"
                                     "QPushButton:hover{background-color: rgb(0,255,0);}"
                                     "QPushButton{background-color:rgb(255,255,0)}"
                                     "QPushButton{border:2px}"
                                     "QPushButton{border-radius:5px}"
        ...
        self.vid_img = QLabel()
        self.vid_img.setPixmap(QPixmap("images/UI/lzy01.jpeg"))
        vid_title.setAlignment(Qt.AlignCenter)
        self.vid_img.setAlignment(Qt.AlignCenter)
        self.webcam_detection_btn = QPushButton("摄像头实时检测")
        self.mp4_detection_btn = QPushButton("视频文件检测")
        self.vid_stop_btn = QPushButton("停止检测")
        self.webcam_detection_btn.setFont(font_main)
        self.mp4_detection_btn.setFont(font_main)
        self.vid_stop_btn.setFont(font_main)
        self.webcam_detection_btn.setStyleSheet("QPushButton{color:blue}"
                                                "QPushButton:hover{background-color: rgb(0,255,0);}"
                                                "QPushButton{background-color:rgb(255,255,0)}"
                                                "QPushButton{border:2px}"
                                                "QPushButton{border-radius:5px}"
                                                "QPushButton{padding:5px 5px}"
                                                "QPushButton{margin:5px 5px}")
        self.mp4_detection_btn.setStyleSheet("QPushButton{color:blue}"
                                             "QPushButton:hover{background-color: rgb(0,255,0);}"
                                             "QPushButton{background-color:rgb(255,255,0)}"
                                             "QPushButton{border:2px}"
                                             "QPushButton{border-radius:5px}"
                                             "QPushButton{padding:5px 5px}"
                                             "QPushButton{margin:5px 5px}")
        self.vid_stop_btn.setStyleSheet("QPushButton{color:blue}"
                                        "QPushButton:hover{background-color: rgb(0,255,0);}"
                                        "QPushButton{background-color:rgb(255,255,0)}"
                                        "QPushButton{border:2px}"
                                        "QPushButton{border-radius:5px}"
        ...
        about_title = QLabel('\n欢迎使用基于yolov5的智能口罩识别系统')  # todo 修改欢迎词语
        about_title.setFont(QFont('华文行楷', 25))


        about_title.setAlignment(Qt.AlignCenter)
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/UI/lzy03.png'))
        ...
        self.setTabIcon(0, QIcon('images/UI/lzy.png'))
        self.setTabIcon(1, QIcon('images/UI/lzy.png'))
        self.setTabIcon(2, QIcon('images/UI/lzy.png'))
    ...
    ***上传图片***
    ...
    def upload_img(self):
        ...
        if fileName:
            ...
            # todo 上传图片之后右侧的图片重置，
            self.right_img.setPixmap(QPixmap("images/UI/lzy01.jpeg"))
